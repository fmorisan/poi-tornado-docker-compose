...
/root/.foundry/bin/cast send 0x510E4E569e847dFA537Fd24406e6dc52331C2aCa 'updateRoot(uint256,bytes32)' 0x0f3254cbd51d47fe65ec1bec168d2f689f1eda6d2c8464ef3456bf2a7386b7c8 $(/root/.foundry/bin/cast to-bytes32 1) --rpc-url $RPC_URL --private-key $PRIVATE_KEY
